	...
	async render(state: void, sizing: PromptSizing) {
		...
		return <InstructionMessage>
			...
			<Tag name='final_answer_structure_and_style_guidelines'>
				...
				- Adaptation: questions about a passage → precise, structured with references; simple tasks → lead with outcome; big changes → logical walkthrough + rationale + next actions; casual one-offs → plain sentences, no headers/bullets.
			</Tag>
