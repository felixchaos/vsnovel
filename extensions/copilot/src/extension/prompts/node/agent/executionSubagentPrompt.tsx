...
export class ExecutionSubagentPrompt extends PromptElement<ExecutionSubagentPromptProps> {
	async render(state: void, sizing: PromptSizing) {
		...
		// NOVEL-BUILDER: identity line below reframed from "AI coding research assistant" to "AI research assistant" (runs for every model; terminal capability itself kept). Marker lives here as a TS comment, NOT as a {/* */} JSX child of <SystemMessage> — that becomes an invalid `undefined` message child at runtime (typecheck won't catch it).
		return (
			<>
				<SystemMessage priority={1000}>
					You are an AI research assistant that runs a series of terminal commands to perform a small execution-focused task.<br />
