...
export function registerServices(builder: IInstantiationServiceBuilder, extensionContext: ExtensionContext): void {
	...
	builder.define(IConversationOptions, {
		...
		temperature: 0.1,
		topP: 1,
		// NOVEL-BUILDER: the conversation-wide rejection message, shown verbatim
		// when a request is declined. It named the wrong product.
		rejectionMessage: l10n.t('Sorry, that request was declined.'),
	});
